        ...
        <div class="col col-md-offset-3 col-md-6">
            <form action="{{ route('recipes.create') }}" method="POST" id="createrecipe" enctype="multipart/form-data">
                ...
                <div class="row" id="procedure-area">
                    ...
                    <div class="col-sm">
                        <button type="button" onclick="removeProcedure(this)" id="remove-procedure" class="btn btn-outline-primary invisible" name="content[][image]"><img src="{{ asset('images/trashicon.svg')}}" class="trashicon"></button>
                    </div>
                    <div>
